...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Klarbay for wholesale tech enquiries and quotes.",
};
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              ...
              <form className="space-y-4">
                ...
                <button type="submit" className="w-full py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-500">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { t: "Email", v: "info@klarbay.com", d: "Response within 24 hours" },
                    { t: "Address", v: "42 Harbour Walk, Bristol, BS1 6WT", d: "United Kingdom" },
                    { t: "Hours", v: "Monday - Friday", d: "9:00 AM - 6:00 PM GMT" },
                  ].map((c, i) => (
                    <div key={i} className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-semibold text-gray-900">{c.t}</h3>
                      <p className="text-blue-600">{c.v}</p>
